...
const { getUser, updateUser, registerUser, getUserInfo, putUserInfo, deleteUserInfo, getSingleUserInfo, chnagesEmail } = require('../controller/user.controller')
...
userRoutes.get('/user/email-changes', chnagesEmail)
